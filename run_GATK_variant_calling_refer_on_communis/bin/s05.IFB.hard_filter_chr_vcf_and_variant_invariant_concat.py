...
group = 'Jul2024' # group name in the output4_dir
group_new = 'Jul2024' # group name in the output5_dir
...
ref_genome = os.path.join(input_dir, 'assembly_Pyrus_communis_Bartlett_DH_Genome_v2.0','PyrusCommunis_BartlettDHv2.0.fasta')
...
chromosomes = os.path.join(input_dir, 'chromosomes.list')
