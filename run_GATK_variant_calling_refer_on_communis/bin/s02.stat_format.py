...
#Description:
    ...
    # Using sys.argv to read input;
    # Update the s01 output name (output1_dir).
...
# Set path
work_dir = '/shared/ifbstor1/projects/pear_snp3/pear/run_GATK_variant_calling_refer_on_communis/'
group    = sys.argv[1]
...
output1_dir = output_dir+'/s01.fastq_to_gvcf_and_stat.'+group
