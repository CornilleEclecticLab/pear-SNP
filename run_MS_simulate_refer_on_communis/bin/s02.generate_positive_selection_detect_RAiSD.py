...
# @File     : s02.generate_positive_selection_detect_RAiSD.py
# @Author   : NIE Yuqi
# @Email    : nieyuqi.cn@gmail.com
# @Time(CET): 2024-09-13 16:12:26
# @Description:
#    
...
source {os.path.join(bin_dir,'s00.load_RAiSD.sh')}

# Run RAiSD
RAiSD   -n {pop}.REP{repeat} \\
        -I {input_file} \\
        -L 1000000 \\
        -G {grid} 
        # -k 0.05 \\
...
mv RAiSD_*.{pop}.REP{repeat}* {output_dir}
""")
