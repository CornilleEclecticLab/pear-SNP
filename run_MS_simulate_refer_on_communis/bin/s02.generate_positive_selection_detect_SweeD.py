...
# @File     : s02.generate_positive_selection_detect_SweeD.py
# @Author   : NIE Yuqi
# @Email    : nieyuqi.cn@gmail.com
# @Time(CET): 2024-09-13 15:24:03
# @Description:
#    
...
source {os.path.join(bin_dir,'s00.load_SweeD.sh')}
...
SweeD-P \\
    ...
    -folded \\
    -threads 4 &&
mv SweeD_*.{pop}.REP{repeat} {output_dir}
