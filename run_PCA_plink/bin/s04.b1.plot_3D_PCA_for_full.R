...
# Full dataset
prefix_Full <- "../output/branch15.batch42.full/pear_Dec2023.full.Combine_chr.geno20_maf005.anno.syno.thin8k.pca"
...
pop <- read.table("../input/population_group.for_Full.tsv", sep = '\t', header = TRUE)
...
# Define the title
pca_title <- "PCA for Pear"

# Define the shapes 
shapes_index <- c(4,7,17)  
pch_shapes_index <-  shapes_index[c(3,1,2)]  
