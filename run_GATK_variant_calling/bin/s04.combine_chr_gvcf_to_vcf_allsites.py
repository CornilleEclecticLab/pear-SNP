...
#Description:
    # 2023-01-04 17:12:48
    # Version 2.0.0 modify this script for neo
    # 2023-01-06 11:38:12
...
#             dic[sample_name].append(path)
    ...
    for chr in chromosome:
        ...
        gvcf_list = output3_dir+'/all.'+chr_base+".list"
...
gatk --java-options "-Xmx32g" CombineGVCFs \\
    -R {ref_genome} \\
    -V {gvcf_list} \\
    -O {output4_dir}/{chr_base}.combine.g.vcf.gz \\
...
gatk --java-options "-Xmx32g" GenotypeGVCFs \\
    -all-sites \\
    -R {ref_genome} \\
    -V {output4_dir}/{chr_base}.combine.g.vcf.gz \\
    -O {output4_dir}/{chr_base}.combine.vcf.gz \\
