...
#SBATCH -J kinship
#SBATCH -o s04.kinship_variant_geno20.NOGIT.%J.out
#SBATCH -e s04.kinship_variant_geno20.NOGIT.%J.err
#SBATCH -c 8
...
WORKDIR=$(dirname $BIN)
INPUT="$WORKDIR/input"
OUTPUT="$WORKDIR/output/s04.${BATCH}_variant_geno20"
PREFIX="$BATCH.Combine_chr_variant_geno20"
