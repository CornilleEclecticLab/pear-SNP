...
#    Version 2.0.0: 2024-08-16 14:20:10
#    Support different spline types: piecewise (default), cubic, pchip.
#    Add the parameter --em-iterations 50 to the split command.

#    Version 2.0.1: 2024-08-18 21:42:39
#    Booking less cpu and memory for the split command.
...
s02_script_basename = "s02.estimate_by_population_"+f'{spline_type}'
s04_script_basename = "s04.vcf2smc_to_prepare_for_split"
script_basename  = 's05.split_time_estimation'+f'_{spline_type}'
