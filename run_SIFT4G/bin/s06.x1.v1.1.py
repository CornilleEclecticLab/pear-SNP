...
def read_sift4g_annotation(file_path):
    ...
    with open(file_path, 'r') as file:
        ...
        for line in file:
            ...
            ref = parts[2]
            alt = parts[3]
            # e.g. SYNONYMOUS, NONSYNONYMOUS, START-LOST, STOP-GAIN, STOP-LOSS
            variant_type = parts[8]
            sift_score = parts[12]
            prediction = parts[16]
...
def process_vcf_files(ref_genome, sift_annotations, cds_length_dic, bed_region_per_pop):
    ...
    for vcf_file in vcf_file_list:
        ...
        s_variant = vcf_parser.parse_vcf(
            ...
            if args.region_type != 'all_masked':
                for region_bed in args.bed_files:
                    ...
                    tmp_bedfile = os.path.join(
                        temp_dir, f'{ref_genome}_{pop}.{args.region_type}.type_vs_cds.bed')
