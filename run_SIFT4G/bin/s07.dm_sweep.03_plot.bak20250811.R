...
ggsave2("../output/s06.dm_sweep/pop_allele_CDS.all_mask.mutation_burden.svg", p_m, width=10, height=3)
ggsave2("../output/s06.dm_sweep/pop_allele_CDS.all_mask.mutation_burden.pdf", p_m, width=10, height=3)
