...
p_w <- ggboxplot(
  ...
  bxp.errorbar = TRUE,
  add = "jitter",
  add.params = list(alpha = 0.2, size = 1.5, shape = 16)
) +
  ...
  annotate("text", x = 1.5, y = 100, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y = 100, label = "wild", size = 7/2.845,  angle = 0) +
...
p_e <- ggboxplot(
  ...
  annotate("text", x = 3, y=100, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 7, y=100, label = "wild/rootstock", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
...
# Adjust the margins for the second plot
p_m1 <- ggarrange(
...
p_w <- ggboxplot(
  ...
  labs(
   x = NULL, # "Occidental populations", 
    y = "No. of deleterious alleles/CDS length\n in different regions", 
    color = "Region type",
    fill = "Region type"
  ) +
...
p <- ggboxplot(df_sweep_hohe_all_mask, x = "pop", y = "de_per_100k_cds",
  ...
  theme_bw(base_size = 7) +
  labs(x = "Populations", y = "No. of deleterious alleles/CDS\nlength in either status") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
p
...
p_w <- ggboxplot(
  ...
  theme_bw(base_size = 7) +
  labs(
   x =  "Occidental pear populations", 
  y = "No. of deleterious homozygous\n/CDS length in different regions", 
    color = "Region type",
    fill = "Region type"
  ) +
...
p_e <- ggboxplot(
  ...
  theme_bw(base_size = 7) +
    labs(x = "Oriental pear populations",
         y = NULL)+ #, color="Region type") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1),
          axis.text.y = element_blank()) +
  scale_x_discrete(labels = c(
...
p <- ggboxplot(df_sweep_hohe_sel_con, x = "pop", y = "de_per_100k_cds",
               color = "group", palette = "npg", group.by = "region_type") +
  theme_bw(base_size = 7) +
  labs(x = "Populations", y = "No. of deleterious alleles/CDS length") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) # +
...
p_w <- ggboxplot(
  ...
  scale_color_manual(
    ...
    geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
    annotate("text", x = 1.5, y=80, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 3.5, y=80, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
...
p_e <- ggboxplot(
    ...
    geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
    annotate("text", x = 3, y=80, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 7, y=80, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
...
###################
## Fig e: (supplyment) hetezygous selection with control
###################
...
p_w <- ggboxplot(
    ...
    geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
    annotate("text", x = 1.5, y=60, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 3.5, y=60, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
...
p_e <- ggboxplot(
    ...
    geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
    annotate("text", x = 2.5, y=75, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 7, y=75, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
...
p_w <- ggboxplot(
  ...
  annotate("text", x = 1.5, y = 100, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y = 100, label = "wild", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y = 25, label = "", size = 7/2.845,  angle = 0) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
    # aes(group = region_type),
    comparisons = my_comparisons,
...
p_e2 <- ggboxplot(
  ...
  geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 3, y=100, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 7, y=100, label = "wild or rootstock", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y = 25, label = "", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
  labs(x = "Oriental populations", y = NULL, color="Region type") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))  +
...
save_myplot(p_m1, "../output/s06.dm_sweep/fig_a.pop_allele_CDS_1.all_mask.mutation_burden" )
...
p_e <- ggboxplot(
  ...
  geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 3, y=100, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 7, y=100, label = "wild", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
  labs(x = "Oriental populations", y = NULL, color="Region type") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
p_w <- ggboxplot(
    ...
    geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
    annotate("text", x = 1.5, y=0.25, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 3.5, y=0.25, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
...
p_e <- ggboxplot(
    ...
    annotate("text", x = 2.5, y=0.28, label = "cultivar", size = 7/2.845,  angle = 0) +
    annotate("text", x = 5.5, y=0.28, label = "wild", size = 7/2.845,  angle = 0) +
    theme_bw(base_size = 7) +
    labs(x = "Oriental populations", y = NULL, color="Region type") +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
p_w <- ggboxplot(
  ...
  geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 1.5, y=0.7, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y=0.7, label = "wild", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
...
p_e <- ggboxplot(
  ...
  geom_vline(xintercept = 4.5, linetype = "dashed", color = "black") +
  annotate("text", x = 2.5, y=0.8, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 5.5, y=0.8, label = "wild", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
  labs(x = "Oriental populations", y = NULL, color="Region type") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
p_w <- ggboxplot(
  ...
  geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 1.5, y=10000, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 3.5, y=10000, label = "wild", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
...
p_e <- ggboxplot(
  ...
  geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 2.5, y=10000, label = "cultivar", size = 7/2.845,  angle = 0) +
  annotate("text", x = 7, y=10000, label = "wild", size = 7/2.845,  angle = 0) +
  theme_bw(base_size = 7) +
...
p_snp_w <- ggboxplot(
  ...
  geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 1.5, y = 0.15, label = "cultivar", size = 7/2.845, fontface = "bold") +
  annotate("text", x = 3.5, y = 0.15, label = "wild", size = 7/2.845, fontface = "bold") +
  labs(x = "Occidental populations", y = "No. of Deleterious\nalleles/SNP") +
  theme_bw(base_size = 7) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
p_snp_e <- ggboxplot(
  ...
  geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 2.5, y = 0.2, label = "cultivar", size = 7/2.845, fontface = "bold") +
  annotate("text", x = 7, y = 0.2, label = "wild", size = 7/2.845, fontface = "bold") +
...
p_syno_w <- ggboxplot(
  ...
  geom_vline(xintercept = 2.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 1.5, y = 0.3, label = "cultivar", size = 7/2.845, fontface = "bold") +
  annotate("text", x = 3.5, y = 0.3, label = "wild", size = 7/2.845, fontface = "bold") +
...
p_syno_e <- ggboxplot(
  ...
  geom_vline(xintercept = 5.5, linetype = "dashed", color = "grey40") +
  annotate("text", x = 2.5, y = 0.4, label = "cultivar", size = 7/2.845, fontface = "bold") +
  annotate("text", x = 7, y = 0.4, label = "wild", size = 7/2.845, fontface = "bold") +
  labs(x = "Oriental populations", y = NULL) +
  theme_bw(base_size = 7) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
