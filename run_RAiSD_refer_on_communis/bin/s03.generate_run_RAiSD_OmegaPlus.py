...
omegaplus_output_dir = os.path.join(os.path.dirname(work_dir), omegaplus_output_dir)
            ...
            if grid_method == 'no_grid':
                ...
                for grid_window in grids_windows:
                    ...
                    if not os.path.exists(omegaplus_file):
                        ...
                        omegaplus_result = open(omegaplus_file, 'r').read().strip().split('\n')
